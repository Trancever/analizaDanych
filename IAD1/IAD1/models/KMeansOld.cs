...
namespace IAD1.models
{
    ...
    {
        private List<List<double>> rawData = new List<List<double>>();
        ...
        public List<List<double>> KMeansMethod(List<List<double>> inputData)
        {
            double[][] data = inputData.Select(a => a.ToArray()).ToArray();
